...
INSERT INTO
    SETTLEMENT_PARTICIPANT (SETTLEMENT_ID, MEMBER_ID)
VALUES
    (1, 1);
...
VALUES
    ('train', 1, 1, 80000, CURRENT_TIMESTAMP());
...
VALUES
    ('train', 2, 1, 150000, CURRENT_TIMESTAMP());
...
VALUES
    ('train', 3, 1, 100000, CURRENT_TIMESTAMP());
...
VALUES
    ('chicken', 4, 1, 100, CURRENT_TIMESTAMP());